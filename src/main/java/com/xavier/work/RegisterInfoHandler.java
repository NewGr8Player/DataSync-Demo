...
@Component
public class RegisterInfoHandler extends AbstractHandler {
	...
	public void onInsert(List<CanalEntry.Column> afterList) {
		this.stcTracePigService.save(this.stcTracePigService.stcTracePigButcherCollector(afterList));
	}
	...
	public void onDelete(List<CanalEntry.Column> beforeList) {
		this.stcTracePigService.save(this.stcTracePigService.stcTracePigButcherDeleteCollector(beforeList));
	}
}
